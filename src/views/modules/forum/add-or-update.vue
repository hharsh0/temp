            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="input" v-if="type != 'info'" label="帖子标题" prop="forumName">
                        <el-input v-model="ruleForm.forumName" placeholder="帖子标题" clearable
                            :readonly="ro.forumName"></el-input>
                    </el-form-item>
                    <div v-else>
                        <el-form-item class="input" label="帖子标题" prop="forumName">
                            <el-input v-model="ruleForm.forumName" placeholder="帖子标题" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type != 'info'" label="发布内容" prop="forumContent">
                        <el-input type="textarea" v-model="ruleForm.forumContent" placeholder="发布内容" clearable
                            :readonly="ro.forumName"></el-input>
                    </el-form-item>
                    <div v-else>
