                ...
                <el-row class="ad"
                    ...
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                            ...
                            href="http://localhost:8080/liulangdongwubeihua/upload/newsMuBan.xls">批量导入公告信息数据模板</a>
                        &nbsp;
                        <el-upload v-if="isAuth('news', '导入导出')" style="display: inline-block"
                            action="liulangdongwubeihua/file/upload" :on-success="newsUploadSuccess"
...
export default {
    ...
    methods: {
        ...
        deleteHandler(id) {
            try {
                // Ensure that dataListSelections exists and is an array before calling map()
